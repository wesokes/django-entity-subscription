...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationMedium.entity'
        db.add_column(u'entity_subscription_notificationmedium', 'entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['entity.Entity']),
                      keep_default=False)


        # Changing field 'Action.render_class_path'
        db.alter_column(u'entity_subscription_action', 'render_class_path', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
        # Adding field 'Medium.render_class_path'
        db.add_column(u'entity_subscription_medium', 'render_class_path',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationMedium.entity'
        db.delete_column(u'entity_subscription_notificationmedium', 'entity_id')


        # User chose to not deal with backwards NULL issues for 'Action.render_class_path'
        raise RuntimeError("Cannot reverse this migration. 'Action.render_class_path' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Action.render_class_path'
        db.alter_column(u'entity_subscription_action', 'render_class_path', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Deleting field 'Medium.render_class_path'
        db.delete_column(u'entity_subscription_medium', 'render_class_path')
