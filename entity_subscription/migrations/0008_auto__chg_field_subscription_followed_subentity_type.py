...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.followed_subentity_type'
        db.alter_column(u'entity_subscription_subscription', 'followed_subentity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))

    def backwards(self, orm):

        # Changing field 'Subscription.followed_subentity_type'
        db.alter_column(u'entity_subscription_subscription', 'followed_subentity_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entity.Entity']))
