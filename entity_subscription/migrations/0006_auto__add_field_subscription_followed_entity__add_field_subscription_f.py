...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.followed_entity'
        db.add_column(u'entity_subscription_subscription', 'followed_entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['entity.Entity']),
                      keep_default=False)

        # Adding field 'Subscription.followed_subentity_type'
        db.add_column(u'entity_subscription_subscription', 'followed_subentity_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['entity.Entity']),
                      keep_default=False)


        # Changing field 'Subscription.action'
        db.alter_column(u'entity_subscription_subscription', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_subscription.Action'], null=True))

    def backwards(self, orm):
        # Deleting field 'Subscription.followed_entity'
        db.delete_column(u'entity_subscription_subscription', 'followed_entity_id')

        # Deleting field 'Subscription.followed_subentity_type'
        db.delete_column(u'entity_subscription_subscription', 'followed_subentity_type_id')


        # User chose to not deal with backwards NULL issues for 'Subscription.action'
        raise RuntimeError("Cannot reverse this migration. 'Subscription.action' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Subscription.action'
        db.alter_column(u'entity_subscription_subscription', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_subscription.Action']))
